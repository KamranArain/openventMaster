 ...
 static  int tempInit = 1;
  ...
  if (calibStatus != ST_IN_PROG)
  {
      ...
      {    
        ...
        else {if (ctr == (1000/samplePeriod1)) ctr = 0;}        
        ctr++;
    ...
    switch (status.breathPhase)
    {
      ...
      case EXPIRATION_PHASE:
        ...
        if (setpoint.curAssistMode_F == 1) {
          ...
          {
            Serial.print("Set Trigger: "); Serial.println(setpoint.flowTriggerSenstivity);
...
//#ifdef __DEBUG
// #ifndef TEL_AT_UART0
          //  Serial.print(F("Breath Number: ")); Serial.println(breathNumber);
          ...
          //  Serial.print(F("Comp Mech Fail         ")); Serial.println(status.compressionMechFailure); 

          breathNumber++;
          //  Serial3.println(breathNumber++);
          //  Serial3.print(F(","));  Serial3.print(TEL.Time); //0 = VOL; 1 = PRESS          
          //  Serial3.print(F(","));  Serial3.print(setpoint.curVentMode); //0 = VOL; 1 = PRESS          
          //  Serial3.print(F(","));  Serial3.print(breathLength);
          //  Serial3.print(F(","));  Serial3.print(Tin);
          //  Serial3.print(F(","));  Serial3.print(Tex);
          //  Serial3.print(F(","));  Serial3.print(reqMotorPos);
          //  Serial3.print(F(","));  Serial3.print(Vin);
          //  Serial3.print(F(","));  Serial3.print(Vex);
          //  Serial3.print(F(","));  Serial3.print(RPMin);
          //  Serial3.print(F(","));  Serial3.print(RPMex);
          //  Serial3.print(F(","));  Serial3.print(stepIn);
          //  Serial3.print(F(","));  Serial3.print(stepEx);
          //  Serial3.print(F(","));  Serial3.print(periodIn);
          //  Serial3.print(F(","));  Serial3.print(periodEx); 
          //  Serial3.print(F(","));  Serial3.print(status.compressionMechFailure); 
          //  Serial3.print(F(","));  Serial3.print(scanBreathingAttempt); 
          //  Serial3.print(F(","));  Serial3.print(patientTriggeredBreath); 
          //  Serial3.print(F(","));  Serial3.print(control->motorIsWorking*50);
          //  Serial3.print(F(","));  Serial3.print(control->valuePredicted,5);
          //  Serial3.print(F(","));  Serial3.print(control->error, 5);
          //  Serial3.print(F(",")); Serial3.print(FS.Q_SLM, 5);
          //  Serial3.print(F(",")); Serial3.print(TV.measured, 5);
          //  Serial3.print(F(",")); Serial3.print(p_sensor.pressure_gauge_CM, 5);
          //  Serial3.print(F("\n"));
// #endif           
...
//#endif
    ...
    Tcur = millis() - BreathStartTimestamp;
      ...
      if (Tcur <= Tin)
      {
        if (initIns)
        {
          Serial3.print(F("Breath Number : ")); Serial3.println(breathNumber-1);
          Serial3.print(F("Timestamp : "));  Serial3.println(TEL.Time); //0 = VOL; 1 = PRESS          
...
void loop()
{
  ...
  {
    // Serial.print("Timestamp: ");Serial.println(millis()-start_Ts);
